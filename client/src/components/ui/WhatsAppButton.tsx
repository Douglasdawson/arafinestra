...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`group fixed right-6 z-50 flex items-center justify-center w-14 h-14 bg-green-500 rounded-full shadow-lg hover:scale-110 hover:bg-green-600 transition-all duration-300 animate-whatsapp-pulse ${
