    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8 max-w-3xl mx-auto items-center">
        ...
        <div className="flex-1 space-y-6 w-full max-w-sm">
          {/* Width */}
          <div>
            <label htmlFor="dim-ancho" className="block text-sm font-medium text-slate-700 mb-2">{t("calculator.width")}</label>
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                inputMode="numeric"
                className="w-20 px-3 py-2 text-base border border-slate-300 rounded-lg text-center font-mono focus:ring-2 focus:ring-brand focus:border-brand"
              />
            </div>
          </div>
          ...
          {/* Height */}
          <div>
            <label htmlFor="dim-alto" className="block text-sm font-medium text-slate-700 mb-2">{t("calculator.height")}</label>
            <div className="flex items-center gap-3">
              <input
                type="range"
          ...
          {/* Leaves */}
          <div>
            <label id="dim-hojas-label" className="block text-sm font-medium text-slate-700 mb-2">{t("calculator.leaves")}</label>
            <div role="group" aria-labelledby="dim-hojas-label" className="flex gap-2">
              {[1, 2, 3, 4].map((n) => (
                <button
                  key={n}
                  type="button"
                  aria-pressed={hojas === n}
